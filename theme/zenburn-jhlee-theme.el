...
(deftheme zenburn-jhlee
  "The Zenburn theme - jhlee mod.")
...
(let (
	  ...
	  (zenburn-jhlee-mode-line-bg "#Daa520")
	  (zenburn-jhlee-mode-line-bg-1 "#8b6508")
	  (zenburn-jhlee-mode-line-fg "#000000")
	  (zenburn-jhlee-mode-line-fg+1 "#303030")
  ...
  (custom-theme-set-faces
   ...
   `(zenburn-primary-1 ((t (:foreground ,zenburn-yellow-1))))
   ...
   `(zenburn-highlight-alerting ((t (:background ,zenburn-red-4))))
   `(zenburn-highlight-subtle ((t (:background ,zenburn-bg+2))))
   ...
   `(zenburn-title ((t (:inherit variable-pitch :weight bold :inherit default))))
   ...
   `(fringe ((t (:inherit default :background ,zenburn-bg+1))))
   `(header-line ((t (:inherit zenburn-highlight-damp :box (:color "#2e3330" :line-width 2)))))
   `(highlight ((t (:weight bold :underline nil :inherit zenburn-highlight-subtle))))
   `(hover-highlight ((t (:underline t :foreground ,zenburn-yellow))))
   `(match ((t (:inherit zenburn-highlight-alerting :underline nil))))
   `(menu ((t (:background "#1e2320"))))
   `(mouse ((t (:inherit zenburn-foreground))))
   `(paren ((t (:inherit zenburn-red)))) ;;'zenburn-lowlight-1))))
   ...
   `(button ((t (:foreground ,zenburn-yellow-2 :underline t))))
   `(cursor ((t (:background "#aaaaaa" :foreground nil))))
   `(escape-glyph-face ((t (:foreground ,zenburn-red))))
   `(minibuffer-prompt ((t (:foreground ,zenburn-yellow))))
   `(mode-line ((t (:inverse-video nil :background ,zenburn-jhlee-mode-line-bg :foreground ,zenburn-jhlee-mode-line-fg :height 1.0))))
   `(mode-line-inactive ((t (:background ,zenburn-jhlee-mode-line-bg-1  :foreground ,zenburn-jhlee-mode-line-fg+1 :inherit mode-line))))
   ...
   `(org-todo ((t (:foreground ,zenburn-red :weight bold))))
   `(org-upcoming-deadline ((t (:inherit font-lock-keyword-face-face))))
   `(org-warning ((t (:foreground ,zenburn-red :weight bold))))
   ...
   `(show-paren-match ((t (:foreground ,zenburn-orange :background ,zenburn-bg+2 :weight bold :underline nil))))
   ...
   `(anything-dir-priv ((t (:inherit bold))))
   `(anything-file-name ((t (:foreground ,zenburn-yellow-1))))
   `(anything-grep-file ((t (:foreground ,zenburn-yellow-1))))
   `(anything-grep-match ((t (:inherit zenburn-red))))
   `(anything-overlay-line-face ((t (:inherit region))))
   `(anything-dir-heading ((t (:inherit zenburn-highlight-damp))))
   `(anything-match ((t (:inherit zenburn-highlight-damp))))
   ...
   `(wg-current-workgroup-face ((t (:foreground ,zenburn-red-4 :inherit wg-mode-line-face))))
