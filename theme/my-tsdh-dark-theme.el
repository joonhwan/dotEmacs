(deftheme my-tsdh-dark
  "Created 2013-03-31.")

(custom-theme-set-faces
 'my-tsdh-dark
 '(default ((t (:family "Menlo" :foundry "apple" :width normal :height 120 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "white smoke" :background "gray20" :stipple nil :inherit nil))))
 '(bold ((t (:weight bold))))
 ...
 '(header-line ((t (:box nil :inverse-video t :foreground "grey90" :background "grey20" :inherit (mode-line)))))
 ...
 '(mode-line-inactive ((t (:weight light :box (:line-width -1 :color "grey40" :style nil) :foreground "gray" :background "grey30" :inherit (mode-line)))))
 ...
 '(diff-added-face ((t (:background "dark green" :inherit (diff-changed)))))
 ...
 '(diff-removed-face ((t (:background "dark red" :inherit (diff-changed)))))
 ...
 '(hl-line ((t (:background "grey28" :inherit (highlight)))))
 ...
 '(org-agenda-structure ((t (:weight bold :foreground "SkyBlue"))))
