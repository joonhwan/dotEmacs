...
(custom-theme-set-faces
 ...
 '(paren ((t nil)))
 '(trailing-whitespace
   ((((class color) (background light)) (:background "gray91"))
	(((class color) (background dark)) (:background "red4"))
	(t (:inverse-video t))))
 ...
 '(mode-line ((((class color) (min-colors 88)) (:foreground "black" :background "goldenrod1" :box (:line-width -1 :color nil :style released-button)))
			  (t (:inverse-video t))))
 ...
 '(font-lock-builtin-face
   ((((class grayscale) (background light)) (:weight bold :foreground "LightGray"))
	...
	(((class color) (min-colors 88) (background light)) (:foreground "royal blue"))
 ...
 '(font-lock-comment-face ((t (:slant italic :foreground "DarkSeaGreen4"))))
 ...
 '(font-lock-type-face ((t (:foreground "chocolate4"))))
