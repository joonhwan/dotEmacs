(deftheme my-deeper-blue
  "blue feel dark theme")

(custom-theme-set-faces
 'my-deeper-blue
 '(default ((t (:family "Menlo" :foundry "apple" :width normal :height 120 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "gray80" :background "#181a26" :stipple nil :inherit nil))))
 '(bold ((t (:weight bold))))
 ...
 '(compilation-info ((t (:weight normal :foreground "LightSkyBlue" :inherit (success)))))
 ...
 '(diff-context-face ((t (:foreground "seashell4" :inherit (shadow)))))
 ...
 '(ediff-current-diff-A ((t (:foreground "white" :background "green4"))))
 '(ediff-current-diff-B ((t (:foreground "white" :background "darkorange3"))))
 ...
 '(info-node ((t (:weight bold :slant italic :foreground "DeepSkyBlue1"))))
 '(info-title-4 ((t (:family "helv" :weight bold :inherit (variable-pitch)))))
 '(info-xref ((t (:foreground "SeaGreen2" :inherit (link)))))
 ...
 '(outline-1 ((t (:foreground "SkyBlue1" :inherit (font-lock-function-name-face)))))
 '(outline-2 ((t (:foreground "CadetBlue1" :inherit (font-lock-variable-name-face)))))
 '(outline-3 ((t (:foreground "LightSteelBlue1" :inherit (font-lock-keyword-face)))))
 '(outline-4 ((t (:foreground "turquoise2" :inherit (font-lock-comment-face)))))
 '(outline-5 ((t (:foreground "aquamarine1" :inherit (font-lock-type-face)))))
 ...
 '(show-paren-match ((t (:foreground "white" :background "dodgerblue1"))))
 '(show-paren-mismatch ((t (:foreground "white" :background "red1"))))
