...
(let (
	  ...
	  (my-dark-yellow+2 "#Ffe94f")
	  (my-dark-yellow+1 "#efb94f")
	  (my-dark-yellow   "#df790f")
	  (my-dark-yellow-1 "#bd950c")
	  (my-dark-yellow-2 "#8b6508")
	  (my-dark-yellow-3 "#4b3508")
	  (my-dark-yellow-4 "#2f2520")
  ...
  (custom-theme-set-faces
   ...
   `(trailing-whitespace ((t (:background ,my-dark-yellow-4))))
   ...
   `(org-level-1 ((t (:height 1.1 :foreground ,my-dark-yellow+2 :inherit default))))
   `(org-level-2 ((t (:height 1.0 :foreground ,my-dark-yellow+1 :inherit org-level-1))))
   `(org-level-3 ((t (:height 1.0 :foreground ,my-dark-yellow :inherit org-level-2))))
   `(org-level-4 ((t (:height 1.0 :foreground ,my-dark-yellow-1 :inherit org-level-3))))
   `(org-level-5 ((t (:foreground ,my-dark-blue-1 :inherit org-level-4))))
   `(org-level-6 ((t (                            :inherit org-level-5))))
   `(org-level-7 ((t (:foreground ,my-dark-blue-3 :inherit org-level-6))))
   `(org-level-8 ((t (:foreground ,my-dark-blue-3 :inherit org-level-7))))
