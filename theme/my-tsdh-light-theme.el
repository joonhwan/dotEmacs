(deftheme my-tsdh-light
  "Created 2013-03-31.")

(custom-theme-set-faces
 'my-tsdh-light
 '(default ((t (:family "Menlo" :foundry "apple" :width normal :height 120 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "black" :background "white" :stipple nil :inherit nil))))
 '(bold ((t (:weight bold))))
 ...
 '(header-line ((t (:box nil :inverse-video t :foreground "grey20" :background "grey90" :inherit (mode-line)))))
 ...
 '(mode-line ((t (:family "DejaVu Sans" :box (:line-width -1 :color "red" :style released-button) :foreground "black" :background "grey75"))))
 '(mode-line-inactive ((t (:weight light :box (:line-width -1 :color "grey75" :style nil) :foreground "dim gray" :background "grey90" :inherit (mode-line)))))
 ...
 '(diff-added-face ((t (:background "light green" :inherit (diff-changed)))))
 ...
 '(diff-removed-face ((t (:background "sandy brown" :inherit (diff-changed)))))
 ...
 '(hl-line ((t (:background "grey95" :inherit (highlight)))))
 ...
 '(org-agenda-date-today ((t (:underline (:color foreground-color :style line) :inherit (org-agenda-date)))))
 '(org-agenda-date-weekend ((t (:foreground "dark green" :inherit (org-agenda-date)))))
 '(org-agenda-structure ((t (:family "DeJaVu Sans" :height 1.1 :weight bold :foreground "Blue1"))))
 ...
 '(outline-1 ((t (:weight bold :inherit (font-lock-function-name-face)))))
 '(outline-2 ((t (:weight bold :inherit (font-lock-variable-name-face)))))
 '(outline-3 ((t (:weight bold :inherit (font-lock-keyword-face)))))
 '(outline-4 ((t (:weight bold :inherit (font-lock-comment-face)))))
 '(outline-5 ((t (:weight bold :inherit (font-lock-type-face)))))
 '(outline-6 ((t (:weight bold :inherit (font-lock-constant-face)))))
 '(outline-7 ((t (:weight bold :inherit (font-lock-builtin-face)))))
 '(outline-8 ((t (:weight bold :inherit (font-lock-string-face)))))
 ...
 '(rcirc-my-nick ((t (:weight bold :foreground "LightSkyBlue"))))
 ...
 '(show-paren-mismatch ((t (:foreground "white" :background "deep pink"))))
