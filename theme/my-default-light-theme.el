...
(custom-theme-set-faces
 ...
 '(custom-group-tag ((t (:height 1.2 :weight bold :foreground "blue1" :inherit (variable-pitch)))))
 '(custom-group-tag-1 ((t (:height 1.2 :weight bold :foreground "red1" :inherit (variable-pitch)))))
 ...
 '(diff-refine-added ((t (:background "#aaffaa" :inherit (diff-refine-change)))))
 ...
 '(helm-selection ((t (:underline (:color foreground-color :style line) :background "#b5ffd1"))))
 ...
 '(info-xref ((t (:weight normal :slant normal :underline (:color foreground-color :style line) :inverse-video nil :foreground "#2075c7" :inherit (link)))))
 ...
 '(org-date ((t (:underline (:color foreground-color :style line) :foreground "Purple"))))
...
(provide-theme 'my-default-light)
