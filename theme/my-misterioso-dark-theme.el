...
(custom-theme-set-faces
 ...
 '(default ((t (;; :family "Menlo" :foundry "apple"
						:width normal ;; :height 120
							   :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#e1e1e0" :background "#2d3743" :stipple nil :inherit nil))))
 '(bold ((t (:weight bold))))
