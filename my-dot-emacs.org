  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (setq el-get-sources
          '(
            ...
            (:name nose
                   :description "eays python test running in emacs"
                   :type github
...
** Python Programming
   #+BEGIN_SRC emacs-lisp
     (when (functionp 'elpy-enable)
       (setq my-elpy-python-dir (concat (file-name-directory (locate-library "elpy")) "elpy"))
       (let ((old-pythonpath (getenv "PYTHONPATH")))
         (if old-pythonpath
             (setenv "PYTHONPATH" (concat old-pythonpath ":" my-elpy-python-dir))
           (setenv "PYTHONPATH" my-elpy-python-dir)))
       (elpy-enable)
       )
   #+END_SRC
