...
(when (my-try-require 'helm-swoop)
  ...
  ;; (define-key helm-map (kbd ".") 'helm-multi-swoop-all)
...
;;   ;; (define-key helm-map (kbd "C-l") 'helm-filelist)
;;   (define-key helm-map (kbd "h v") 'my-helm-help-variable-or-function)
;;   (define-key helm-map (kbd "h f") 'my-helm-help-function-or-variable)
;;   (define-key helm-map (kbd "o h") 'helm-org-headlines)
;;   (define-key helm-map (kbd "o k") 'helm-org-keywords)
;;   (when (featurep 'eproject)
;; 	(define-key helm-map (kbd "j") 'my-helm-source-eproject-files)
;; 	)
;;   (when (featurep 'projectile)
;;   	(define-key helm-map (kbd "j") 'helm-projectile))
;;   (define-key helm-map (kbd "M-s o") 'my-helm-occur)
;;   (global-set-key (kbd "C-c a") helm-map)
;;   )
